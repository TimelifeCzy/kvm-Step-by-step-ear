...
static void vmlaunch_entry()
{
	return printk(KERN_EMERG "[+]entry vmlaunch\n");
}

static void vmlaunch_exit()
{
	return printk(KERN_EMERG "[+]exit vmlaunch\n");
}

static void vmresume_output()
{
	return printk(KERN_EMERG "[+]call vmresume\n");
}
